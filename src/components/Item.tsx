        ...
        <div className="product">
            ...
            <form className="itemForm" onSubmit={handleSubmit}>
                <div className="nameInput field">
                    ...
                    {
                        formValidation.name ? <></> : <div className="error">must have a name shorter then 20 characters</div>
                    }
                ...
                <div className="descriptionInput field">
                    ...
                    {
                        formValidation.description ? <></> : <div className="error">description needs to have up to 200 characters</div>
                    }
                ...
                <div className="priceInput field">
                    ...
                    {
                        formValidation.price ? <></> : <div className="error">price must be positive</div>
                    }
